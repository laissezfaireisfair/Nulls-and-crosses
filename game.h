...
namespace nullsAndCrosses {
    ...
    class Game {
		...
		int  count_dio_1_with_point(const char player, const Point newPoint) const;
		/// И на другой
		int  count_dio_2_with_point(const char player, const Point newPoint) const;
		...
		/// Проверка на ничью
		bool is_draw_or_no(const int num_steps, const int size) const;
